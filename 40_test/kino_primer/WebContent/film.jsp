    ...
    <div class="bg-content">
		<div id="content" class="content-extra"><div class="ic"></div>
    		<div class="container">
					...
					%> 
              		...
              		<%String ocenili = "";
            			...
            			<figure class="img-indent"><img src="<%=o.getPoster()%>" alt="" style="width:200px;height:270px;" ></figure>
                			...
                			<br>
                			<%if((o.getTrailer().compareTo("")!=0)||(o.getTrailer()!=null)) {%>
            	...
            	<div class="tab">
  					<button class="tablinks" onclick="openCity(event, 'vsi')" id="defaultOpen">Vsi</button>
  					<button class="tablinks" onclick="openCity(event, 'ljubljana')">Ljubljana</button>
  					<button class="tablinks" onclick="openCity(event, 'kranj')">Kranj</button>
				...
				<ul class="portfolio clearfix">
				  <% for (Show s:sh.selectShow()){ %>
								<% int b = s.getMovieID(); %>
									<%if(a == b){ %>
									<%if(s.getCity().compareTo("Ljubljana")==0){ %>
									<%	if(request.getParameter("showDate")!=null){ %>
									<%  String dare = request.getParameter("showDate");  	
     				   					String startDateString = "06/27/2007";
     				   					DateFormat df = new SimpleDateFormat("yyyy-MM-dd"); 
				...
				<div id="kranj" class="tabcontent">
				<ul class="portfolio clearfix">
				  <% for (Show s:sh.selectShow()){ %>
								<% int b = s.getMovieID(); %>
									<%if(a == b){ %>
									<%if(s.getCity().compareTo("Kranj")==0){ %>
									<%	if(request.getParameter("showDate")!=null){ %>
									<%  String dare = request.getParameter("showDate");  	
     				   					String startDateString = "06/27/2007";
     				   					DateFormat df = new SimpleDateFormat("yyyy-MM-dd"); 
            			...
            			<% for(User u:us.selectUser()) {%>
            				...
            				<% String vsebina = c.getContent();
            					String parsedStr = vsebina.replaceAll("(.{40})", "$1\n");%>
            					     <c:set var = "parsedStr1" value = "<%=parsedStr %>"/>
     									${fn:escapeXml(parsedStr1)}
